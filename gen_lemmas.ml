...
let extra_cap_funs = StringSet.of_list ["writeCapReg"; "readCapReg"; "readCapRegDDC"]
let privileged_regs = StringSet.of_list [
  "KCC"; "KDC"; "EPCC"; "ErrorEPCC"; "KR1C"; "KR2C"; "CapCause"]
let cap_inv_regs = StringSet.of_list ["PCC"]
let mem_inv_regs = StringSet.of_list ["CP0Status"; "TLBContext"; "TLBXContext"; "TLBEntryHi"]
let conf_regs = StringSet.of_list []
let fun_renames = []
let reg_ref_renames = []
let cap_types = StringSet.of_list ["Capability"]
let skip_funs = StringSet.of_list ["writeCapReg"; "readCapReg"; "readCapRegDDC"; "execute"; "initialize_registers"; "cp2_next_pc"; "init_cp2_state"]

let extra_cap_reg_assms = [("readCapReg", "CapRegs_names \\<subseteq> accessible_regs s"); ("readCapRegDDC", "CapRegs_names \\<subseteq> accessible_regs s")]
