...
subsection \<open>ISA abstraction\<close>

text \<open>Generated by Lem from \<open>cheri_axioms.lem\<close>.\<close>
...
subsection \<open>Intra-instruction properties\<close>
